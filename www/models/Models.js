        ...
        xhr.onreadystatechange = () => {
          ...
          if(xhr.readyState == 4) {
            ...
            if(xhr.status == 200) {
              ...
              var dados = JSON.parse(xhr.responseText);
              aviso("Certinho! <small style='font-size:13px;display:block;'>Vamos conectar você ao profissional.</small>","Em BREVE, você estará RECEBENDO ORÇAMENTOS dos PROFISSIONAIS cadastrados nossa plataforma!");
